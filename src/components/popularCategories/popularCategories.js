...
class PopularCategories extends React.Component{
  render() {
    return (
      <div style={{display:'flex', background:'yellow',justifyContent:'center'}}>
        <div style={{maxWidth:'300px',maxHeight:'300px',width:'calc(100vw/6)',background:'red',height:'calc(100vw/6)'}}>
        </div>
        <div style={{maxWidth:'300px',maxHeight:'300px',width:'calc(100vw/6)',background:'yellow',height:'calc(100vw/6)'}}>
        </div>
        <div style={{maxWidth:'300px',maxHeight:'300px',width:'calc(100vw/6)',background:'green',height:'calc(100vw/6)'}}>
        </div>
      </div>
    )
  }
